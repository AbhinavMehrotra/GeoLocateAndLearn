...
public class InMemoryChallengeDatabase extends ChallengeDatabase {
	...
	private InMemoryChallengeDatabase() {
		...
		createPracticeChallenge("Talk to a stall keeper/seller",
				question, LISTENING, SPEAKING, READING, WRITING);
		//
		...
		createPracticeChallenge(
				"Update your blog in 150 words or less", question,
				READING, WRITING);
		//
		...
		createPracticeChallenge("Ask for directions", question,
		...
		createPracticeChallenge("Buy a train ticket", question,
				LISTENING, SPEAKING, READING);
		//
		...
		createPracticeChallenge("Reserve a hotel room", question,
		...
		createPracticeChallenge("Book a taxi over the telephone",
		...
		createPracticeChallenge("Order a meal in a restaurant",
				question, LISTENING, SPEAKING, READING);
		//
		// instructions =
		...
		createPracticeChallenge(
				"Buy tickets in a cinema to watch a film", question,
				LISTENING, SPEAKING, READING);
		//
		// instructions =
		...
		createPracticeChallenge("Ask for information at a library",
				question, LISTENING, SPEAKING, READING);
		//
		// instructions =
		...
		createPracticeChallenge("Making small talk with a stranger",
				question, LISTENING, SPEAKING);
	}
