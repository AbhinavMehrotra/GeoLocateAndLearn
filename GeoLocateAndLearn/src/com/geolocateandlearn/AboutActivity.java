...
public class AboutActivity extends Activity {
	...
	private void loadOutput() {
		...
		int questionCount = 0;
		for (String question : challenge1) {
			questionCount++;
		}

		outputBuilder.append(Integer.toBinaryString(questionCount));
		outputBuilder.append("b questions.");

		outputTextView.setText(outputBuilder.toString());

		final ChallengeRecord<PracticeChallenge> crClone = record1
				.clone();
	}
